...
const AboutMe = () => {
    return (
        <div className='bg-black text-white font-mono flex flex-col items-center gap-12'>
        <h3 className='text-xl'>About Me </h3>
        <div className='flex flex-col  md:flex-row-reverse'>
            <div className='  w-1/2 mt-0 m-20'>
                <img className='ro' src="./img/yo.png" alt="foto de Leandro" />
            </div>
            <div className='w-1/2 flex flex-col ml-20 mt-0 tracking-wide leading-loose '>
                ...
                <a href="https://www.coderhouse.es/certificados/62cef10568a396001923b533" className='mb-2 rounded-md p-2 transition-colors hover:bg-[#8888889b]'><div className='flex items-center font-sans text-xs  transition-colors'><img className='mr-4 w-12' src="./img/coderimg.jpeg" alt="coder house" /> <div className='flex flex-col gap-3'> <b className='mr-2'> Web development</b> <p>Coder House - June 21, 2022 </p></div>   </div></a>
