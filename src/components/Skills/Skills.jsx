...
const Skills = () => {
    return (
        ...
        <div className='flex flex-wrap items-end justify-center gap-16 px-4 md:px-20 mb-20 '>
            ...
            <div className=' p-2 transition-colors hover:bg-[#8888889b] rounded-md max-w-[10vh] md:max-w-[17vh] h-[20vh] justify-between flex flex-col items-center  gap-2'><img src="./img/pngwing.com.png"alt="ReactJs" /><p>React Js</p></div>
            ...
            <div className=' p-2 transition-colors hover:bg-[#8888889b] rounded-md max-w-[10vh] md:max-w-[17vh] h-[20vh] justify-between  flex flex-col items-center  gap-2'><img src="./img/pngwing.com (12).png" alt="html" /><p>Html</p></div>
            ...
            <div className=' p-2 transition-colors hover:bg-[#8888889b] rounded-md max-w-[10vh] md:max-w-[17vh] h-[20vh] justify-between flex flex-col items-center  gap-2'><img src="./img/pngwing.com (14).png" alt="Sass" /><p className=''>Sass</p></div>
            <div className=' p-2 transition-colors hover:bg-[#8888889b] rounded-md max-w-[10vh] md:max-w-[17vh] flex flex-col items-center  h-[20vh] justify-between gap-2'><img src="./img/pngwing.com (15).png" alt="Tailwind css" /><p>Tailwind Css</p></div>
